...
export function toCaixaDiario(obj: any): CaixaDiarioSupabase {
  return {
    ...
    total_vendas: obj?.total_vendas != null ? toNumber(obj?.total_vendas, 0) : undefined,
    total_entradas: obj?.total_entradas != null ? toNumber(obj?.total_entradas, 0) : undefined,
    valor_saidas: obj?.valor_saidas != null ? toNumber(obj?.valor_saidas, 0) : undefined,
    total_pix: obj?.total_pix != null ? toNumber(obj?.total_pix, 0) : undefined,
    total_debito: obj?.total_debito != null ? toNumber(obj?.total_debito, 0) : undefined,
    total_credito: obj?.total_credito != null ? toNumber(obj?.total_credito, 0) : undefined,
    total_dinheiro: obj?.total_dinheiro != null ? toNumber(obj?.total_dinheiro, 0) : undefined,
    total_caderneta: obj?.total_caderneta != null ? toNumber(obj?.total_caderneta, 0) : undefined,
    diferenca: obj?.diferenca != null ? toNumber(obj?.diferenca, 0) : undefined,
    ...
    diferenca_dinheiro: obj?.diferenca_dinheiro != null ? toNumber(obj?.diferenca_dinheiro, 0) : undefined,
    diferenca_pix: obj?.diferenca_pix != null ? toNumber(obj?.diferenca_pix, 0) : undefined,
    diferenca_debito: obj?.diferenca_debito != null ? toNumber(obj?.diferenca_debito, 0) : undefined,
    diferenca_credito: obj?.diferenca_credito != null ? toNumber(obj?.diferenca_credito, 0) : undefined,
  }
}
